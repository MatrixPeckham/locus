...
<div id="circleview">
    <div id="circleinfo">
        <div id="circlehead">
            <h1>${circle.name}</h1>
            <h6>${circle.catagory} (${circle.pub?"Public":"Private"})</h6>
        ...
        <div class="hidden" id="editcirclediv">
            <form onsubmit="javascript:void(0)" action="javascript:void(0)" >
                <input type="text" id="editcirclename" value="${circle.name}"></input>
                <input type="text" id="editcirclecatagory" value="${circle.catagory}"></input>
                <input type="checkbox" id="publiccheck" ${circle.pub?"checked":""}>Public</input>
                <input type="submit" value="Save" onclick="saveCircle(${circle.id})"></input>
            </form>
        </div>
    </div>
    <div> 

 ...
 * @author Owner
 */
public class LoopEmployeeAdsTagHandler extends SimpleTagSupport {
    private int empl;
    ...
    public void doTag() throws JspException {
        ...
        try {
            ...
            ArrayList<AdBean> list = DBManager.get().getEmployeesAds(empl);
            for(AdBean b : list){
            ...
            throw new JspException("Error in LoopEmployeeAdsTagHandler tag", ex);
        }
    }

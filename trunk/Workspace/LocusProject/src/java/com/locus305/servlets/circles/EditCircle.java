 ...
 */
package com.locus305.servlets.circles;
 ...
 * @author Owner
 */
public class EditCircle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean pub = Boolean.parseBoolean(request.getParameter("pub"));
